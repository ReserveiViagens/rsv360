...
**App:** `apps/turismo`  
**Atualizado:** 2026-06-20 (cluster #95 concluído)
**Baseline global:** **88** warnings  
...
|---------|-------|
| Warnings globais | **88** | | | |
| Clusters concluídos | **95** / 120 | / 120 | / 120 | / 120 |
| PR empilhada mais recente | **#TBD** (cluster #95, −6) |
| Próximo cluster | **#96** — (−6) |
