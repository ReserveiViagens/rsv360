...
**App:** `apps/turismo`  
**Atualizado:** 2026-06-20 (cluster #91 concluído)  
**Baseline global:** **112** warnings  
...
| Métrica | Valor |
|---------|-------|
| Warnings globais | **112** |
| Clusters concluídos | **91** / 120 |
| PR empilhada mais recente | **#506** (cluster #91, −6) |
| Próximo cluster | **#92** — (−6) |
