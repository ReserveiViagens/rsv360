...
**App:** `apps/turismo`  
**Atualizado:** 2026-06-20 (cluster #112 concluído)
**Baseline global:** **27** warnings warnings warnings warnings warnings warnings warnings warnings warnings warnings warnings  
...
| PR empilhada mais recente | **#527** (cluster #112, −3) |
