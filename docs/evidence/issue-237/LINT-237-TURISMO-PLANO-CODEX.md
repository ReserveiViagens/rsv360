...
**App:** `apps/turismo`  
**Atualizado:** 2026-06-02 (cluster #6 concluído)  
**Baseline global:** **2666** warnings  
...
| Métrica | Valor |
|---------|-------|
| Warnings globais | **2666** |
| Clusters concluídos | **6** / 120 |
| PR empilhada mais recente | **#418** (cluster #6, −72) |
...
- [x] Clusters **1–6** (2666 warnings restantes)
- [ ] Clusters **7–120**
