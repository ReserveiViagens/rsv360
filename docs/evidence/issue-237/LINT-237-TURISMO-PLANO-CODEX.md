...
**App:** `apps/turismo`  
**Atualizado:** 2026-06-20 (cluster #47 concluído)  
**Baseline global:** **840** warnings  
...
| Métrica | Valor |
|---------|-------|
| Warnings globais | **840** |
| Clusters concluídos | **47** / 120 |
| PR empilhada mais recente | **#462** (cluster #47, −27) |
