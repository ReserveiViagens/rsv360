...
- [x] Lint analytics-financeiro + recommendations + sales-dashboard −24 — **GO condicional** *(PR #466)* — `issue-237/LINT-237-TURISMO-ANALYTICS-RECOMMENDATIONS-SALES.md`
- [x] Lint seo + ReportsPage + BookingsPage −24 — **GO condicional** *(PR #467)* — `issue-237/LINT-237-TURISMO-SEO-REPORTS-BOOKINGS.md`
