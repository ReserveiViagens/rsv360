...
- [x] Lint #237 admin/guest/turismo — **GO** *(esta PR)* — `issue-237/LINT-237-ADMIN-GUEST-TURISMO-POST-T0.24.md`
...
| **Próximo passo** | T1.2 auth session (#374) | débito TS turismo 125 | redução warnings turismo |
