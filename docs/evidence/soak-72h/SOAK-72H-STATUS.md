...
**Ultima atualizacao:** 2026-06-11T04:00:02-03:00  
...
| Baseline | **OK** (`000`) |
| Amostras | **11 linhas TSV** — 000–007 OK; 008 FAIL+recovery OK; **009 OK**; 010–012 pendentes |
...
- **Próximo slot:** 010 @ **2026-06-11 10:00** -03.
...
.\docs\evidence\soak-72h\run-soak-sample.ps1 -SampleId "010" -Force
