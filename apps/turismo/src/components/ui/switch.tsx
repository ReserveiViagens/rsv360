...
const Switch = radixUiExport<SwitchProps, HTMLButtonElement>(
  React.forwardRef<HTMLButtonElement, SwitchProps>(function Switch({ className, ...props }, ref) {
    return radixCreate(SwitchPrimitives.Root, {
      className: cn(
      ...
      ...props,
      ref,
      children: radixCreate(SwitchPrimitives.Thumb, {
        className: cn(
