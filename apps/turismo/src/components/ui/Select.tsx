...
const SelectTrigger = radixUiExport<SelectTriggerProps, HTMLButtonElement>(
  React.forwardRef<HTMLButtonElement, SelectTriggerProps>(function SelectTrigger(
    { className, children, ...props },
    ref
  ) {
    return radixCreate(SelectPrimitive.Trigger, {
      ref,
      className: cn(
...
const SelectScrollUpButton = radixUiExport<SelectScrollUpButtonProps, HTMLDivElement>(
  React.forwardRef<HTMLDivElement, SelectScrollUpButtonProps>(function SelectScrollUpButton(
    { className, ...props },
    ref
  ) {
    return radixCreate(SelectPrimitive.ScrollUpButton, {
      ref,
...
const SelectScrollDownButton = radixUiExport<SelectScrollDownButtonProps, HTMLDivElement>(
  React.forwardRef<HTMLDivElement, SelectScrollDownButtonProps>(function SelectScrollDownButton(
    { className, ...props },
    ref
  ) {
    return radixCreate(SelectPrimitive.ScrollDownButton, {
      ref,
      className: cn("flex cursor-default items-center justify-center py-1", className),
      ...props,
...
const SelectContent = radixUiExport<SelectContentProps, HTMLDivElement>(
  React.forwardRef<HTMLDivElement, SelectContentProps>(function SelectContent(
    { className, children, position = "popper", ...props },
    ref
  ) {
    return radixCreate(SelectPrimitive.Portal, {
...
const SelectLabel = radixUiExport<SelectLabelProps, HTMLDivElement>(
  React.forwardRef<HTMLDivElement, SelectLabelProps>(function SelectLabel(
    { className, ...props },
    ref
  ) {
    return radixCreate(SelectPrimitive.Label, {
      ref,
...
const SelectItem = radixUiExport<SelectItemProps, HTMLDivElement>(
  React.forwardRef<HTMLDivElement, SelectItemProps>(function SelectItem(
    { className, children, ...props },
    ref
  ) {
    return radixCreate(SelectPrimitive.Item, {
      ref,
      className: cn(
...
const SelectSeparator = radixUiExport<SelectSeparatorProps, HTMLDivElement>(
  React.forwardRef<HTMLDivElement, SelectSeparatorProps>(function SelectSeparator(
    { className, ...props },
    ref
  ) {
    return radixCreate(SelectPrimitive.Separator, {
      ref,
