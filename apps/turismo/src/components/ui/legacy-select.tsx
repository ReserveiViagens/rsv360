...
/** Select legado (options/onChange) — distinto do Radix Select shadcn. */
  ...
  ({
    ...
    return (
      <div className="w-full space-y-1">
        ...
        <select ref={ref} className="sr-only" {...props} />
      </div>
    );
  }
);
...
export type SelectProps = LegacySelectProps;

/** Alias para consumidores legados (BookingTable, etc.). */
