...
export function generateAllTourTemplates(): BudgetTemplate[] {
  ...
  for (const tour of caldasNovasTours) {
    const template = createTourTemplate({
      ...
      transportIncluded: ('transportIncluded' in tour ? tour.transportIncluded : undefined) !== false,
      guideIncluded: ('guideIncluded' in tour ? tour.guideIncluded : undefined) !== false,
      mealIncluded: ('mealIncluded' in tour ? tour.mealIncluded : undefined) || false,
      difficulty: ('difficulty' in tour ? tour.difficulty : undefined) || 'facil',
      minParticipants: typeof tour === 'object' && 'minParticipants' in tour && typeof tour.minParticipants === 'number' ? tour.minParticipants : 2,
      maxParticipants: typeof tour === 'object' && 'maxParticipants' in tour && typeof tour.maxParticipants === 'number' ? tour.maxParticipants : 20,
