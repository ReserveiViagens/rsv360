...
const AvatarRootEl = asRadix(AvatarPrimitive.Root)
const AvatarImageEl = asRadix(AvatarPrimitive.Image)
const AvatarFallbackEl = asRadix(AvatarPrimitive.Fallback)
