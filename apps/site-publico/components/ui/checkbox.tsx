...
const CheckboxRootEl = asRadix(CheckboxPrimitive.Root)
const CheckboxIndicatorEl = asRadix(CheckboxPrimitive.Indicator)
...
const Checkbox = radixUiExport<CheckboxProps, HTMLButtonElement>(
  React.forwardRef<HTMLButtonElement, CheckboxProps>(({ className, ...props }, ref) => (
    <CheckboxRootEl
      ...
      {...props}
    >
      <CheckboxIndicatorEl className={cn("flex items-center justify-center text-current")}>
